...
public interface CartRepository extends JpaRepository<Cart, Long> {
    ...
    @Query("DELETE FROM CartLine line WHERE line IN (SELECT line FROM CartLine line, Customer customer WHERE customer.id = :customerId AND line.product.id = :productId)")
    @Transactional
    @Modifying
